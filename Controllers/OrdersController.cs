...
namespace MatureFashionsAppV2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(MatureFashions2Context context)
        {
            _context = context;
        }
        ...
        {
            var matureFashions2Context = _context.Orders.Include(o => o.FranchiseNoNavigation);
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var orders = await _context.Orders
                .Include(o => o.FranchiseNoNavigation)
        ...
        public async Task<IActionResult> Create([Bind("OrderNo,OrderDate,FranchiseNo")] Orders orders)
        {
            ...
            ViewData["FranchiseNo"] = new SelectList(_context.Franchises, "FranchiseNo", "FranchiseNo", orders.FranchiseNo);
            return View(orders);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("OrderNo,OrderDate,FranchiseNo")] Orders orders)
        {
            if (id != orders.OrderNo)
            {
                return NotFound();
            }
